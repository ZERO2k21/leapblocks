import{r as s,R as x}from"./index-CIriCm2H.js";let $;try{$=require("skulpt"),$||($=window.Sk)}catch(e){console.warn("[SkulptEngine] Direct require failed, will use window.Sk:",e),$=window.Sk}const ie=`
class Sprite:
...
//# sourceMappingURL=index-R6RKdNH6.js.map

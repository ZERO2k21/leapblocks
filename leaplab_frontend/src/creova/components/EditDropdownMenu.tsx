...
export const EditDropdownMenu: React.FC<EditDropdownMenuProps> = ({
  ...
  return (
    <div
      className={`absolute top-full mt-1.5 left-0 rounded-xl min-w-[220px] py-1.5 z-50 overflow-hidden backdrop-blur-xl shadow-2xl border transition-all animate-[creovaEditSlideIn_0.18s_ease-out] ${
        isElectra

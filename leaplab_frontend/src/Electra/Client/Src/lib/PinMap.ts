...
export function getComponentPins(type: string): PinEntry[] {
  ...
  return pins.map((pin: any) => {
    ...
    const isSvgComponent = ['led', 'rgb-led', 'pushbutton', 'pushbutton-6mm', 'led-bar-graph', 'neopixel', 'neopixel-matrix', 'led-ring', 'stepper-motor', 'a4988', 'biaxial-stepper', 'ks2e-m-dc5', 'relay-module', 'ili9341', 'ili9341-touch', 'ssd1306', 'mpu6050', 'pir-motion-sensor', 'ir-obstacle-sensor', 'rfid-rc522', 'rfid-sensor', 'hc-sr04', 'dht22', 'dht11', 'ntc-temperature-sensor', 'photoresistor-sensor', 'flame-sensor', 'gas-sensor', 'heart-beat-sensor', 'big-sound-sensor', 'small-sound-sensor', 'hx711', 'ds1307', 'membrane-keypad', 'rotary-dialer', 'l298n', 'dc-motor', 'battery-12v', 'esp32-c3', 'ky-040', 'slide-potentiometer', 'tilt-switch'].includes(type);

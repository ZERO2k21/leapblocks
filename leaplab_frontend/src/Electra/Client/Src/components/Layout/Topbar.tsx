        ...
        <>
          ...
          >
            ...
            <div className="flex items-center gap-3.5 flex-auto min-w-0 h-full">
              <button
                ...
                className={`flex items-center justify-center w-10 h-10 ml-4 rounded-xl cursor-pointer transition-colors duration-200 shrink-0 border ${
                  isElectra
              ...
              <div className="hidden min-[1440px]:flex items-center gap-3 h-full">
                ...
                <div ref={fileMenuRef} className="relative">
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-3.5 py-2 text-sm font-semibold rounded-full transition-all tracking-wide cursor-pointer border-0 ${
                      isElectra ? 'text-zinc-100 hover:bg-cyan-400/10' : 'text-white hover:bg-white/10'
                ...
                <button
                  type="button"
                  className={`flex items-center gap-1.5 px-3.5 py-2 text-sm font-semibold rounded-full transition-all tracking-wide cursor-pointer border-0 bg-transparent ${
                    isElectra ? 'text-zinc-100 hover:bg-cyan-400/10' : 'text-white hover:bg-white/10'
                  }`}
                >
            ...
            <div className="flex items-center justify-end gap-3 flex-auto min-w-0">
              ...
              <div className={`hidden sm:flex items-center gap-3 pr-4 mr-2 border-r h-8 shrink-0 ${isElectra ? 'border-zinc-800' : 'border-blue-200/20'
                ...
                <button
                  ...
                  className={`bg-transparent border-none cursor-pointer transition-colors duration-200 flex items-center ${isElectra ? 'text-zinc-400 hover:text-cyan-400' : 'text-blue-200/85 hover:text-white'}`}
                >
                  {shareLoading ? (
              ...
              <div className="hidden sm:flex sm:items-center sm:gap-4 shrink-0 ml-4">
                <LeapLabAuthButton variant="dark" size="sm" className="h-9 rounded-2xl box-border" />
              </div>
          ...
          >
            ...
            <div className={`border-t pt-4 flex flex-col gap-4 ${isElectra ? 'border-zinc-800' : 'border-white/10'
              ...
              {rightContent}
              <LeapLabAuthButton variant="dark" size="sm" className="h-10 rounded-lg box-border w-full text-base font-semibold" />
            </div>
          </div>
        </>
      )}

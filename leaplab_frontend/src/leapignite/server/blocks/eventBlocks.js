...
export function defineEventBlocks(Blockly, javascriptGenerator) {
    ...
    javascriptGenerator.forBlock['broadcast_message'] = (block) => `window.broadcastMessage("${block.getFieldValue("MESSAGE")}");\n${wait()}`;

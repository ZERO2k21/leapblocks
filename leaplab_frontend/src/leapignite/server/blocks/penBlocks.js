...
export function definePenBlocks(Blockly, javascriptGenerator) {
    ...
    javascriptGenerator.forBlock['pen_set_color'] = (block) => `setPenColor("${block.getFieldValue("COLOR")}");\n${wait()}`;
    ...
    javascriptGenerator.forBlock['pen_set_size'] = (block) => `setPenSize(${block.getFieldValue("SIZE")});\n${wait()}`;
}

...
const TYPE_ICONS = {
    'Image Classifier': '🖼️', 'Object Detection': '🔍', 'Pose Classifier': '🧍',
    'Hand Pose Classifier': '🖐️', 'Audio Classifier': '🎙️', 'Text Classifier': '📝',
    'Numbers (C/R)': '📊',
};
    ...
    return (
        <div className="neura-app">
            ...
            <div className="bg-gradient-to-r from-violet-50 to-purple-50 border-b border-violet-100 px-6 py-3 flex items-center gap-4 flex-wrap">
                ...
                <button onClick={onCreateNew} className="neura-btn-primary text-sm px-5 py-2">
                    + New Project
                </button>
            </div>
            ...
            <div className="flex-1 min-h-0 overflow-y-auto p-6">
                {filtered.length === 0 ? (
                    ...
                    <div className="neura-empty-state animate-neura-fade">
                        ...
                        <button onClick={onCreateNew} className="neura-btn-primary px-8 py-3 text-sm">
                            ...
                            {filtered.map((project, i) => (
                                ...
                                >
                                    ...
                                    <div className="flex justify-center">
                                        <span className={`neura-tag border ${STATUS_STYLES[project.status] || STATUS_STYLES['Untrained']}`}>
                                            {project.status}
                                        </span>
                                    </div>
                                </div>

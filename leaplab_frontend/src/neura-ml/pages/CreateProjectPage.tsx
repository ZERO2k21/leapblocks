...
export default function CreateProjectPage({
  ...
  const handleCreate = (): void => {
    ...
    onCreate({
      ...
      type: selectedType.label as ProjectType,
    });
  };
              ...
              <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
                  {PROJECT_TYPES.map((type: ProjectTypeOption, i: number) => (
                    ...
                    >
                      <div
                        className={`w-14 h-10 rounded-lg flex items-center justify-center text-2xl transition-transform group-hover:scale-110 ${
                          selectedType?.id === type.id
                            ? 'bg-white shadow-sm'
                            : 'bg-gray-100'
                        }`}

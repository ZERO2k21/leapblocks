            ...
            <div className="max-w-3xl mx-auto space-y-5 p-6">
                ...
                <div className="bg-green-50 border border-green-200 rounded-xl p-4 animate-neura-slide-up">
                    ...
                    <p className="text-xs text-green-700 leading-relaxed">
                        Detects 80+ common objects (person, car, cat, chair…) using a pre-trained model. No training needed.
                    </p>
                </div>
                ...
                {!modelReady && (
                    <div className="neura-card p-8 text-center animate-neura-scale">
                        ...
                        <button onClick={loadModel} disabled={loading} className="neura-btn-primary px-8 py-3">
                    ...
                    <>
                        <div className="flex gap-3 items-center animate-neura-slide-up neura-delay-1">
                            <button onClick={running ? stopDetection : startDetection}
                                className={`neura-btn-primary ${running ? '!bg-red-500 hover:!bg-red-600' : ''}`}>
                        ...
                        <div className="relative bg-black rounded-2xl overflow-hidden ring-1 ring-gray-200 animate-neura-scale neura-delay-2" style={{ minHeight: 320 }}>

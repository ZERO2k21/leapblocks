/**
 * TestingPanel — Live testing with webcam or file upload.
 * Shows real-time confidence bars.
 */
import { useRef, useState, useCallback, useEffect } from 'react';

const BAR_COLORS = ['bg-violet-500', 'bg-teal-500', 'bg-orange-400', 'bg-pink-500', 'bg-blue-500', 'bg-green-500'];
...
export default function TestingPanel({
    ...
    return (
        <div className="neura-side-panel animate-neura-slide-up neura-delay-3">
            {/* Header */}
            ...
            {!actualTrained ? (
                <div className="p-6 text-center">
                    ...
                    <p className="text-[11px] text-gray-400 leading-relaxed">
                        Train a model first to start testing.
                    </p>
                </div>
            ) : (
                            ...
                            {sorted.map(([label, conf], i) => (
                                <div key={label} className="animate-neura-slide-up" style={{ animationDelay: `${i * 0.05}s` }}>
                                    ...
                                    <div className="neura-confidence-bar">
                                        <div
                                            className={`neura-confidence-fill ${BAR_COLORS[i % BAR_COLORS.length]}`}

...
export default function DancePosePanel({ mode }: DancePosePanelProps) {
    ...
    }, [mode.mode, camera.stream, modelLoading, camera.startCamera, confidenceThreshold, drawSkeletonOverlay, sequencePhase])
                            ...
                            <div className="relative rounded-2xl overflow-hidden bg-[#0a0128] flex-1 min-h-[300px]">
                                ...
                                {!camera.cameraOn && (
                                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                                        ...
                                        <button onClick={camera.startCamera} className="px-5 py-2.5 text-white rounded-xl text-xs font-bold shadow-lg bg-pink-500 hover:bg-pink-600 transition-colors">Turn On Camera</button>
                                    </div>
                                )}
                            </div>
                            <div className="flex items-center justify-center gap-2">
                                <button onClick={camera.toggleCamera} className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[10px] font-bold border border-pink-500 text-pink-500 bg-white hover:bg-pink-50 transition-colors">
                            ...
                            <div className="relative rounded-2xl overflow-hidden bg-[#0a0128] flex-1 min-h-[300px]">
                                ...
                                {!camera.cameraOn && (
                                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                                        ...
                                        <button onClick={camera.startCamera} className="px-5 py-2.5 text-white rounded-xl text-xs font-bold shadow-lg bg-pink-500 hover:bg-pink-600 transition-colors">Start Camera</button>
                                    </div>
                                )}
                            </div>

# Contributing to leap Elements

First of all, thank you for considering contributing to leap Elements!
...
[file an issue](https://github.com/leap/leap-elements/issues/new/choose)
...
pins that you define. To see the pin locations, add the `<leap-show-pins>`
utility element to your story:

1. Wrap your element with the <leap-show-pins> element, e.g.
   ```
   export const HCSR04 = () => html`
     <leap-show-pins>
       <leap-hc-sr04></leap-hc-sr04>
     </leap-show-pins>
   `;
   ```
2. When you are happy with the pin definition, please remove the `<leap-show-pins>`

...
export const PIN_MAP: PinLayout = {
  ...
  'arduino-nano': [
    ...
    { name: '12', x: 14.26, y: 6.85 }, { name: '11', x: 19.69, y: 6.85 },
    { name: '10', x: 25.12, y: 6.85 }, { name: '9', x: 30.55, y: 6.85 },
    { name: '8', x: 35.98, y: 6.85 }, { name: '7', x: 41.41, y: 6.85 },
    { name: '6', x: 46.85, y: 6.85 }, { name: '5', x: 52.28, y: 6.85 },
    { name: '4', x: 57.71, y: 6.85 }, { name: '3', x: 63.14, y: 6.85 },
    { name: '2', x: 68.57, y: 6.85 }, { name: 'GND.2', x: 74.00, y: 6.85 },
    { name: 'RESET.2', x: 79.43, y: 6.85 }, { name: '0', x: 84.86, y: 6.85 },
    { name: '1', x: 90.29, y: 6.85 },

    // Bottom Row: Y = (62.4 * 0.254) / 17.8 = 89.04%
    { name: '13', x: 14.26, y: 89.04 }, { name: '3.3V', x: 19.69, y: 89.04 },

...
export const getUniqueFileName = (desiredName, existingFiles) => {
...
export const buildAssetPlaceholder = (file, kind) => [
    `# Imported ${kind} asset`,
    `name = "${file.name}"`,
...
export const getFallbackActiveFile = (files, preferred, defaultFile = "main.py") => {

...
const PRESET_BACKDROPS = [
    { id: 'preset_maze', name: 'Maze', src: '/assets/backdrops/maze.svg', color: '#FFD54F' },
    { id: 'preset_park', name: 'Park', src: '/assets/backdrops/park.svg', color: '#66BB6A' },
    { id: 'preset_underwater', name: 'Underwater', src: '/assets/backdrops/underwater.svg', color: '#0288D1' },
    { id: 'preset_space', name: 'Space', src: '/assets/backdrops/space_bg.svg', color: '#1A237E' },
    { id: 'preset_city', name: 'City', src: '/assets/backdrops/city.svg', color: '#607D8B' },
    { id: 'preset_arctic', name: 'Arctic', src: '/assets/backdrops/Artic.png', color: '#E0F7FA' },
    { id: 'preset_beach', name: 'Beach', src: '/assets/backdrops/Beach.png', color: '#FFF9C4' },
    { id: 'preset_castle', name: 'Castle', src: '/assets/backdrops/Castle.png', color: '#E1BEE7' },
    { id: 'preset_space_photo', name: 'Galaxy', src: '/assets/backdrops/Space.png', color: '#0D0D2B' },
];

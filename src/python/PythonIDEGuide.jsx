...
const sections = [
  ...
  },
  {
    ...
    icon: "📦",
    items: [
      { name: "Search bar", desc: "Filter packages by name in the sidebar" },
      { name: "● READY", desc: "Package is included in Skulpt and available to import" },
      { name: "INSTALL button", desc: "Marks the package as available for import in your scripts" },
      { name: "Built-in modules", desc: "math, random, time, json, re, sys are pre-available" },
      { name: "Additional modules", desc: "datetime, collections, itertools can be enabled via PIP" },
    ],
  },
  {
    id: "spriteapi",

...
export class MakeyMakeyRuntime {
    ...
    private startKeyboardFallback() {
        ...
        if ((window as any).__makeyMakeyRuntimeHandler) {
            try {
                window.removeEventListener('keydown', (window as any).__makeyMakeyRuntimeHandler);
            } catch (err) {}
            (window as any).__makeyMakeyRuntimeHandler = null;
        }
        ...
        this._keyboardHandler = (e: KeyboardEvent) => {
            ...
            if (e.key === ' ' || e.key === 'Spacebar') {
                console.log('[MakeyMakey Runtime Debug] Space key pressed.', {
                    target: target,
        ...
        (window as any).__makeyMakeyRuntimeHandler = this._keyboardHandler;
    ...
    private stopKeyboardFallback() {
        if (this._keyboardHandler) {
            ...
            if ((window as any).__makeyMakeyRuntimeHandler === this._keyboardHandler) {
                (window as any).__makeyMakeyRuntimeHandler = null;
            }

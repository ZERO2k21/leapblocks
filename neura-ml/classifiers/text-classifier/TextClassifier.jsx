// classifiers/text-classifier/TextClassifier.jsx
...
export default function TextClassifier({ project, onBack }) {
    const [classes, setClasses] = useState([{ id: 1, name: 'Category 1', samples: [] }, { id: 2, name: 'Category 2', samples: [] }])
    ...
    const handlePredict = () => {
        ...
        const confidences = {}; Object.entries(scores).forEach(([k, v]) => confidences[k] = v / total)
